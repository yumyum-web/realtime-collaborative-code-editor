  ...
  ((c.prototype.init = function (b) {
    ...
    function d(c, d, f) {
      ...
      if (f) b.showTooltip(f, d);
        ...
        e.tooltipOptions.lines.track === !0
      ) {
        var i = { distance: -1 };
        (a.each(b.getData(), function (a, c) {
          ...
          var l = { x: c.data[f][0], y: c.data[f][1] },
            m = { x: c.data[j][0], y: c.data[j][1] },
          ...
          if (n < e.tooltipOptions.lines.threshold) {
            var o = g(l.x, l.y, d.x, d.y) < g(d.x, d.y, m.x, m.y) ? f : j,
              p =
                ...
                [d.x, l.y + (m.y - l.y) * ((d.x - l.x) / (m.x - l.x))]),
              q = { datapoint: p, dataIndex: o, series: c, seriesIndex: a };
            (-1 === i.distance || n < i.distance) &&
              (i = { distance: n, item: q });
          }
        }),
    ...
    (b.hooks.bindEvents.push(function (b, f) {
      if (
        ...
        e.plotOptions.tooltip !== !1 &&
          "undefined" != typeof e.plotOptions.tooltip)
      ) {
    ...
    (c.prototype.getDomElement = function () {
      ...
      return (
        0 === b.length &&
          ((b = a("<div />").attr("id", this.tooltipOptions.id)),
    ...
    (c.prototype.stringFormat = function (a, b) {
      ...
      if (
        ...
        (a = this.hasAxisLabel("xaxis", b)
          ? a.replace(i, b.series.xaxis.options.axisLabel)
          : a.replace(i, "")),
        (a = this.hasAxisLabel("yaxis", b)
          ? a.replace(j, b.series.yaxis.options.axisLabel)
          : a.replace(j, "")),
        ...
        if (b.series.xaxis[p].length > q && !this.isTimeMode("xaxis", b)) {
          var r = this.isCategoriesMode("xaxis", b)
            ? b.series.xaxis[p][q].label
            : b.series.xaxis[p][q].v;
      ...
      if ("undefined" != typeof b.series.yaxis.ticks)
        for (var s in b.series.yaxis.ticks)
          if (b.series.yaxis.ticks.hasOwnProperty(s)) {
            var t = this.isCategoriesMode("yaxis", b)
